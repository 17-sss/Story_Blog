...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
	...
	<div>
	  ...
	  <div class="w3-display-middle">
	    <h1 class="w3-jumbo w3-animate-top"><a href="index.jsp" id="logo">Story Blog</a></h1>
	    ...
	    onclick = "location.href = '#'">Login</button></p>
	    <p class="w3-center w3-small"><a href="#">Sign Up</a></p>
	  </div>
