	...
	<form class="modal-content animate" action="">
	    ...
	    <div class="container">
	      ...
	      <label id="label-text" class="w3-right">
	     	...
	     	<div class="w3-center">
		      <button id="btn" class="w3-button w3-pink w3-large" type="submit" 
		      onclick="location.href='<%=request.getContextPath() %>/Project/view/user_main.jsp'">Login</button>
		      <!-- 버튼에 링크 걸기 => onclick="location.href='joinUs.jsp'" -->
		    </div>
		     <div class= "container">
	    	<p class="w3-right"><a href="<%=request.getContextPath() %>/Project/accountForm.jsp" class="w3-text-black">Sign Up</a></p>
	    	</div>
