...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
	...
	<!-- 관리자 로그인 미완일때 링크.-->
	<%-- <div class="w3-right">
		<a href="<%=request.getContextPath() %>/admin/accountList.jsp">admin..</a>
		<!-- <button class="w3-button w3-small" onclick="alert('준비중입니다...')">admin..</button> -->
	</div> --%>
	<!-- end. 관리자 로그인  -->
	...
	<!-- 기본 디자인 (중앙) -->
	  <div class="w3-display-middle">
		...
		<!-- <p class="w3-center"><input class="w3-center" type="button" value="Sign Up" onclick="goaccountForm()"></p> -->
   ...
   <!-- 로그인 modal --> 
	     <div id="login" class="modal">
	        ...
	        <!-- 로그인 폼 -->
	     <form class="modal-content animate" name="loginInfo" method="post" action="LoginPro.jsp" onsubmit="return checkValue()">
